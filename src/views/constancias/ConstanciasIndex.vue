...
const TIPOS = [
  {
    ...
    descripcion: 'Nombre, fecha de inicio, puesto y salario mensual del empleado.',
        ...
        <div v-else class="max-w-md space-y-4">
          ...
          <div v-if="empleadoSel" class="bg-slate-50 border border-gray-200 rounded-lg p-3 flex items-center gap-3">
            ...
            <div class="min-w-0">
              ...
              <p class="text-xs text-slate-500 truncate">{{ empleadoSel.puesto?.nombre ?? empleadoSel.departamento?.nombre ?? '' }}</p>
            </div>
          </div>
