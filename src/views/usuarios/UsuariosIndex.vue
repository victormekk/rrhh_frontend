        ...
        <tbody>
          ...
          <tr v-else v-for="u in store.usuarios" :key="u.id"
            ...
            <td class="px-5 py-3 text-right whitespace-nowrap">
              <button @click="abrirEditar(u)" class="inline-flex items-center gap-1 text-blue-600 hover:text-blue-800 font-medium mr-4 transition-colors">
              ...
              <button @click="eliminar(u)"
                ...
                class="inline-flex items-center gap-1 text-red-500 hover:text-red-700 font-medium transition-colors disabled:opacity-30 disabled:cursor-not-allowed">
                <svg class="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
